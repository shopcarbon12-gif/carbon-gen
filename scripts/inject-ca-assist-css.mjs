...
const lines = [
  ...
  `'.ca-assist-shell{position:relative;display:block;isolation:isolate;--ca-fab-size:64px}'`,
  `'.ca-assist-launcher--fab{--ca-glow:color-mix(in srgb,var(--ca-accent,#7c3aed) 58%,transparent);position:relative;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;width:var(--ca-launcher-size,64px);height:var(--ca-launcher-size,64px);min-width:0;max-width:none;padding:0;border-radius:50%;border:none;outline:none;color:#f4f4f5;cursor:grab;touch-action:none;-webkit-tap-highlight-color:transparent;transition:transform .18s ease,box-shadow .22s ease,filter .2s ease;background:radial-gradient(circle at 30% 24%,rgba(255,255,255,.22) 0%,color-mix(in srgb,var(--ca-accent,#7c3aed) 38%,rgba(52,36,88,.88)) 42%,rgba(12,8,22,.98) 100%);box-shadow:0 0 0 1px color-mix(in srgb,var(--ca-accent,#a78bfa) 22%,transparent) inset,0 0 40px color-mix(in srgb,var(--ca-accent,#7c3aed) 50%,transparent),0 0 64px color-mix(in srgb,var(--ca-accent,#a78bfa) 26%,transparent),0 18px 44px rgba(0,0,0,.58);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}'`,
  `'.ca-assist-launcher--fab::before{content:\"\";position:absolute;inset:3px;border-radius:50%;pointer-events:none;background:linear-gradient(148deg,rgba(255,255,255,.22) 0%,transparent 45%,transparent 60%,rgba(255,255,255,.05));opacity:.6}'`,
  `'.ca-assist-launcher--fab::after{content:\"\";position:absolute;inset:-4px;border-radius:50%;pointer-events:none;box-shadow:0 0 28px color-mix(in srgb,var(--ca-accent,#7c3aed) 40%,transparent);opacity:.9}'`,
  ...
  `'.ca-assist-launcher--fab .ca-assist-launcher__glyph svg{display:block;width:56%;height:56%}'`,
  ...
  `'.ca-assist-panel{position:absolute;bottom:calc(var(--ca-fab-size, 64px) + 10px + env(safe-area-inset-bottom,0px));max-width:calc(100vw - 24px);width:100%;color:#d4d4d8;border:1px solid rgba(255,255,255,.1);padding:0;border-radius:20px;display:none;max-height:min(82vh,720px);overflow:hidden;flex-direction:column;background:linear-gradient(180deg,rgba(44,28,72,.45) 0%,rgba(18,12,34,.52) 48%,rgba(10,7,20,.54) 100%),linear-gradient(125deg,rgba(130,85,195,.16) 0%,transparent 52%),url(' + JSON.stringify(widgetPanelBg) + ') center center/cover no-repeat;background-color:#0a0614;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);box-shadow:0 36px 90px rgba(0,0,0,.68),inset 0 1px 0 rgba(255,255,255,.05),0 0 0 1px rgba(255,255,255,.03)}'`,
  ...
  `'.ca-assist-panel--mono{background:linear-gradient(180deg,rgba(38,24,62,.52) 0%,rgba(14,9,26,.58) 50%,rgba(8,5,16,.6) 100%),linear-gradient(125deg,rgba(120,80,190,.18) 0%,transparent 52%),url(' + JSON.stringify(widgetPanelBg) + ') center center/cover no-repeat;background-color:#08050f;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px)}'`,
];
