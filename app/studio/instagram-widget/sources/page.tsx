...
export default function InstagramWidgetSourcesPage() {
  return (
    <main style={{ padding: "22px 16px", color: "#f8fafc", maxWidth: 720 }}>
      ...
      <p style={{ color: "rgba(226, 232, 240, 0.85)", lineHeight: 1.5 }}>
        Instagram Graph API connection will be configured here (Phase 2). Use <strong>Layout</strong> for hero and
        previews now.
      </p>
    </main>
  );
