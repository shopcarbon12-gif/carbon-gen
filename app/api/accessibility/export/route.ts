...
export async function GET(req: NextRequest) {
  ...
  const payload = {
    ...
    settings: {
      ...
      accessibilityOwner: String(settings.accessibilityOwner || ""),
      accessibilityOwnerRole: String(settings.accessibilityOwnerRole || ""),
      responseSlaHours: Number(settings.responseSlaHours || 0),
      remediationLogUrl: String(settings.remediationLogUrl || ""),
    },
    checklist: {
      done: checklistDone,
    ...
    const rows = [
      {
        ...
        accessibilityOwner: payload.settings.accessibilityOwner,
        accessibilityOwnerRole: payload.settings.accessibilityOwnerRole,
        responseSlaHours: payload.settings.responseSlaHours,
        remediationLogUrl: payload.settings.remediationLogUrl,
