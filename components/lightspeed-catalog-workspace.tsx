...
export default function LightspeedCatalogWorkspace() {
  ...
  return (
    <main className="page">
      <section className="glass-panel card hero-card">
        <h2>Lightspeed Catalog</h2>
        <p className="hint">
          Live Lightspeed inventory table in Carbon template. Data is read-only with SKU and quantity sort options.
        </p>
      </section>
